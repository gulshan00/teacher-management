...
// import { Bell, ChevronDown, GraduationCap, Search, Settings, User } from 'lucide-react';
...
//           </div>
//           <div>
//             <h1 className="text-xl font-bold text-blue-600">EduManagesssss</h1>
        ...
        <div className="flex flex-wrap items-center gap-3 md:gap-4">
          <div className="relative w-full sm:w-auto">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-full sm:w-64 md:w-80 lg:w-96 pl-10 pr-4 py-2 text-sm border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
